...
function check_if_added_to_cart($item_id) {
    $user_id = $_SESSION['user_id']; //We'll get the user_id from the session// connecting to the database
    ...
    $query = "SELECT * FROM users_items WHERE product_id='$item_id' AND users_id ='$user_id' and status='Added to cart'";
